    ...
    <>
      ...
      <div className="bottom-nav d-lg-none">
        <Nav className="justify-content-around">
          ...
          <Nav.Link as={NavLink} to="/" exact className="bottom-nav-link">
            <FaHome size={24} />
          </Nav.Link>
      ...
      <Nav className="flex-column">
        <Nav.Link as={NavLink} to="/" exact onClick={toggleSidebar} className="nav-link">
        ...
        <Nav.Link as={NavLink} to="/my-courses" onClick={toggleSidebar} className="nav-link">
          <FaBook size={15} /><span className="sidebar-text">My Courses</span>
        </Nav.Link>
